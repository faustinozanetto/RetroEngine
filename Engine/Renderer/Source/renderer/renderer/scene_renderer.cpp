...
namespace retro::renderer
{
    ...
    void scene_renderer::begin_render()
    {
        ...
        const auto lights = s_scene_renderer_data.m_scene->get_actor_registry().group<light_renderer_component>(
            entt::get<name_component, transform_component, model_renderer_component>);
        for (auto &&[actor, light, name, transform, model_renderer] : lights.each())
        {
            ...
            else if (light.type == light_type::directional)
            {
                ...
                lightProjection = glm::ortho(-s_scene_renderer_data.orthoSize,
                                             s_scene_renderer_data.orthoSize,
                                             -s_scene_renderer_data.orthoSize,
                                             s_scene_renderer_data.orthoSize,
                                             s_scene_renderer_data.light_near,
                                             s_scene_renderer_data.light_far);
                glm::vec3 dir = {s_scene_renderer_data.m_lights_data.directional_light.direction.x,
                                 s_scene_renderer_data.m_lights_data.directional_light.direction.y,
                                 s_scene_renderer_data.m_lights_data.directional_light.direction.z};
                lightView = glm::lookAt(-(glm::normalize(dir) * s_scene_renderer_data.light_far / 4.0f), glm::vec3(0.0f), glm::vec3(0.0, 1.0, 0.0));
                lightSpaceMatrix = lightProjection * lightView;
                s_scene_renderer_data.shadow_data.light_view_projection = lightSpaceMatrix;
        ...
        renderer::bind_texture(s_scene_renderer_data.m_shadow_frame_buffer->get_depth_attachment_id(), 7); // shadow
    ...
    {
        s_scene_renderer_data.m_geometry_frame_buffer = frame_buffer::create({2560, 1440, {{"position", frame_buffer_attachment_format::rgba16f}, {"albedo", frame_buffer_attachment_format::rgba16f}, {"normal", frame_buffer_attachment_format::rgba16f}, {"rough-meta-ao", frame_buffer_attachment_format::rgba16f}}});

        s_scene_renderer_data.m_shadow_frame_buffer = frame_buffer::create({2560, 1440, {}});
